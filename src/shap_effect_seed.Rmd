...
# Comparing SHAP values of same data, different seed

```{r}
res_svm_female <- readRDS(paste0(path, 'SHAP_res_svm_female.RDS'))
res_svm_male <- readRDS(paste0(path, 'SHAP_res_svm_male.RDS'))
res_rf_female <- readRDS(paste0(path, 'SHAP_res_rf_female.RDS'))
res_rf_male <- readRDS(paste0(path, 'SHAP_res_rf_male.RDS'))
...
maa_svm_female %>%
  ggplot() +
  geom_point(aes(x=mean_abs_attr, y=Variable, color=as.character(seed))) +
  scale_colour_manual(values=c('#a6cee3','#1f78b4','#b2df8a','#33a02c',
                               '#fb9a99','#e31a1c','#fdbf6f','#ff7f00',
                               '#cab2d6','#6a3d9a')) +
  scale_y_discrete(limits=rev) +
  ggtitle('Mean absolute attribution in different seeds, SVM female') +
  theme_bw() + 
  theme(legend.position="none")
ggsave('../effect_seed_shap_plots/maa_svm_female.png')
...
maa_svm_male %>%
  ...
  scale_colour_manual(values=c('#a6cee3','#1f78b4','#b2df8a','#33a02c',
                               ...
                               '#cab2d6','#6a3d9a')) +
  scale_y_discrete(limits=rev) +
  ggtitle('Mean absolute attribution in different seeds, SVM male') +
  theme_bw() + 
  theme(legend.position="none")
ggsave('../effect_seed_shap_plots/maa_svm_male.png')
...
maa_rf_female %>%
  ...
  scale_colour_manual(values=c('#a6cee3','#1f78b4','#b2df8a','#33a02c',
                               ...
                               '#cab2d6','#6a3d9a')) +
  scale_y_discrete(limits=rev) +
  ggtitle('Mean absolute attribution in different seeds, rf female') +
  theme_bw() + 
  theme(legend.position="none")
ggsave('../effect_seed_shap_plots/maa_rf_female.png')
...
maa_rf_male %>%
  ...
  scale_colour_manual(values=c('#a6cee3','#1f78b4','#b2df8a','#33a02c',
                               ...
                               '#cab2d6','#6a3d9a')) +
  scale_y_discrete(limits=rev) +
  ggtitle('Mean absolute attribution in different seeds, rf male') +
  theme_bw() + 
  theme(legend.position="none")
ggsave('../effect_seed_shap_plots/maa_rf_male.png')
```

# Calculating SHAP values on the full validation set (rather than n=100)
...
# Trying n=1000 for different seeds
